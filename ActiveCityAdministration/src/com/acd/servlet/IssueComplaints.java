...
@WebServlet(urlPatterns = { "/issueComplaints" })
public class IssueComplaints extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		complaint.setComplaintBy(userAccount.getUserId());
		...
		if (resultString == null) {
			try {
				DBUtils.insertComplaint(conn, complaint);
				resultString = "Complaint Raised Successfully";
			} catch (SQLException e) {
				e.printStackTrace();
