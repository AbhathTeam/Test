	...
	<div class="container">
		<div class="fixed">
			<div>
				 ...
				 <input type="hidden" name="userType" value="ROLE_ADMIN" />
                    ...
                    <li><a href="${pageContext.request.contextPath}/adminFeedback">FEEDBACK</a></li>
                    <li><a href="${pageContext.request.contextPath}/officerDetails">OFFICERS</a></li>
		...
		<div class="flex-item">
			<table border="1">
				...
				<c:forEach items="${suggitionList}" var="complaint">
					<tr>
						...
						<td><a href="${pageContext.request.contextPath}/deleteSugg?suggId=${complaint.complaintId}">Delete</a></td>
					</tr>
				</c:forEach>
			</table>
		</div>
